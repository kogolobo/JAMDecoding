...
def constrained_beam_search(
    ...
    while True:
        ...
        # CHANGING TO MATCH CURRENT TRANSFORMER --> ONLY RETURN LOGITS ANYWAYS
        ...
        if neurologic_config.diversity:
            ...
            diversity_logit_processor = HammingDiversityLogitsProcessor(diversity_penalty = 5000.0, num_beams= num_beams, num_beam_groups = num_beam_groups)
            ...
            next_token_scores_processed = next_token_scores
        # -------------
        # take likelihood over whole beam into consideration vs. just likelihood over next token
        next_token_scores = next_token_scores_processed + beam_scores[:, None].expand_as(next_token_scores)

        if neurologic_config.grouping_strategy == "number":
